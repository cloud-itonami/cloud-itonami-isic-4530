# Operator Quickstart — Sale of motor vehicle parts and accessories

Shortest path from clone to a verified local dry-run for **ISIC 4530** (`cloud-itonami-isic-4530`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4530.git
cd cloud-itonami-isic-4530
```
...
- Blueprint governor key: `auto-parts-ops-governor`
